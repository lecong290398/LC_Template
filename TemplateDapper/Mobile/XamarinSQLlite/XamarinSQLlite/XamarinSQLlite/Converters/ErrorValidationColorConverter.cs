...
using XamarinSQLlite.Controls;
using XamarinSQLlite.ViewModels.Forms;

namespace XamarinSQLlite.Converters
{
    /// <summary>
    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                var IsInvalidEmail = !isFocused && !CheckValidEmail(bindingContext.EmailBindProp);
                ...
                return IsInvalidEmail ? Color.FromHex("#FF4A4A") : Color.Transparent;
            ...
            else
            {
                ...
                var IsInvalidEmail = !isFocused1 && !CheckValidEmail(bindingContext.EmailBindProp);
                ...
                return IsInvalidEmail ? Color.FromHex("#FF4A4A") : Color.FromHex("#ced2d9");
